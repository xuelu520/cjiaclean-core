...
public class QueryLocator extends org.apache.axis.client.Service implements com.huazhu.hvip.thirdparty.entity.axis.reservation.Query {
    ...
    public String setquerySoapAddress(String querySoapAddress) {
        return querySoap_address = querySoapAddress + "reservation/query.asmx";
    }
    ...
    public com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_PortType getquerySoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_PortType getquerySoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_BindingStub _stub = new com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_BindingStub(portAddress, this);
    ...
    private String querySoap12_address = "http://10.1.249.75:9097/reservation/query.asmx";
    ...
    public com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_PortType getquerySoap12() throws javax.xml.rpc.ServiceException {
        java.net.URL endpoint;
        try {
    ...
    public com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_PortType getquerySoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap12Stub _stub = new com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_BindingStub _stub = new com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_BindingStub(new java.net.URL(querySoap_address), this);
                _stub.setPortName(getquerySoapWSDDServiceName());
                return _stub;
            }
            if (com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap12Stub _stub = new com.huazhu.hvip.thirdparty.entity.axis.reservation.QuerySoap12Stub(new java.net.URL(querySoap12_address), this);
                _stub.setPortName(getquerySoap12WSDDServiceName());
                return _stub;
            }
        } catch (Throwable t) {
