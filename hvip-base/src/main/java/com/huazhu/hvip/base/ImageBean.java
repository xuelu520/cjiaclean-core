 ...
 * Author:   admin
 * Date:     2016-03-08 17:36:04
 * Description: //模块目的、功能描述
 * History: //修改记录 修改人姓名 修改时间 版本号 描述 需求来源
 * <admin><2016-03-08 17:36:04><version><desc><source>
 *
 */
...
import com.huazhu.hvip.util.NumberUtil;
import com.huazhu.hvip.base.exception.*;
...
public class ImageBean {
	...
	/**
	 * 最大保留修剪成指定的长宽比例图片对象
	 * @param ratioWidth   比例的宽
	 * @param ratioHeight   比例的高
	 */
...
//			encoder.encode(destBufImg);
	...
	public static void main(String [] args){
    	  ...
    	  if (cutPicFile.exists()) {
        	      ...
        	      ImageBean imageBean = new ImageBean("d:/4fcf2283e4b0ef5f78ffd340.jpg");
				  ...
				  for (int i = 0; i < configArray.size(); i++) {
					...
					for (int j = 0; j < filesArray.size(); j++) {
		    			...
		    			if(watermark){
		    				 ...
		    				 String watermarkFilePath ="E:/lesuke/lesuke-b2b/src/main/webapp/init/watermark.png";
