...
public abstract class OrderStatus {
     ...
     * -------------------------------------------------------------
     */
    public static final int ORDER_RIGHTS = -8; // 维权中
    public static final int ORDER_REFUND = -9; //申请退款
    public static final int ORDER_RETURN_REFUSE = -5; //退货被拒绝	拒绝退货
    public static final int ORDER_RETURN_APPLY = -3; // 申请退货
    public static final int ORDER_CANCEL_SHIP = -2; // 退货	退货中
    public static final int ORDER_CANCEL_PAY = -1; // 退款	退款中
    public static final int ORDER_NOT_PAY = 0; // 未付款/新订单       修改为已确认
    public static final int ORDER_PAY_CONFIRM = 2; // 已确认支付	已付款状态
    public static final int ORDER_SHIP = 5; // 已发货
    public static final int ORDER_ROG = 6; // 已收货
    public static final int ORDER_CANCELLATION = 8; // 作废	订单已取消
    public static final int ORDER_COMPLETE = 7; // 已完成	订单已完成
     ...
     * -------------------------------------------------------------
     */
    public static final int REFUND_CANCEL = -2; // 取消退款信息
    public static final int REFUND_FAIL = -1; // 支付失败或退款失败
    public static final int REFUND_WAIT = 0; // 创建待退款信息
    public static final int REFUND_CONFIRM = 2; // 退款成功的状态
     ...
     * -------------------------------------------------------------
     */
    public static final int PAYTYPE_ONLINEPAY = 5;// 在线支付跳支付平台5
    public static final int PAYTYPE_STOREPAY = 6;// 门店进行支付6
    ...
    public static Map<String, Object> getOrderStatusMap() {
        ...
        map.put("ORDER_RIGHTS", OrderStatus.ORDER_RIGHTS);
        map.put("ORDER_REFUND", OrderStatus.ORDER_REFUND);
        ...
        //支付方式的选择
        map.put("PAYTYPE_ONLINEPAY", PAYTYPE_ONLINEPAY);
        map.put("PAYTYPE_STOREPAY", PAYTYPE_STOREPAY);
