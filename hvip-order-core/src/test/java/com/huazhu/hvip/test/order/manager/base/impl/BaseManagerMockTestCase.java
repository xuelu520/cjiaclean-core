 ...
 * FileName: BaseManagerMockTestCase.java
 * Author:   admin
 * Date:     2016-03-08 18:10:30
 * Description: //ģ��Ŀ�ġ���������
 * History: //�޸ļ�¼ �޸������� �޸�ʱ�� �汾�� ���� ������Դ
 * <admin><2016-03-08 18:10:30><version><desc><source>
 *
 */

package com.huazhu.hvip.test.order.manager.base.impl;

import java.util.Map;
import java.util.MissingResourceException;
import java.util.ResourceBundle;

import com.huazhu.hvip.util.ConvertUtil;
