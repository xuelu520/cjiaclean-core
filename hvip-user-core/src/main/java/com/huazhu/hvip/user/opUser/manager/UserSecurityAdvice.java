...
// * FileName: UserSecurityAdvice.java
// * Author:   admin
// * Date:     2016-03-10 14:09:35
// * Description: //模块目的、功能描述
// * History: //修改记录 修改人姓名 修改时间 版本号 描述 需求来源
// * <admin><2016-03-10 14:09:35><version><desc><source>
// */
//
...
////            Collection<? extend GrantedAuthority> roles = auth.getAuthorities();
...
////
////            if (!signupUser) {
////                OpUser currentUser = getCurrentUser(auth);
////
...
////    }
//
//    private OpUser getCurrentUser(Authentication auth) {
//        OpUser currentUser;
//        if (auth.getPrincipal() instanceof UserDetails) {
//            currentUser = (OpUser) auth.getPrincipal();
//        } else if (auth.getDetails() instanceof UserDetails) {
//            currentUser = (OpUser) auth.getDetails();
//        } else {
