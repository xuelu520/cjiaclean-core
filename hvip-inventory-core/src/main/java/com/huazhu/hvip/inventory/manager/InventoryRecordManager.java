 ...
 * @since [产品/模块版本] （可选）
 */
public interface InventoryRecordManager extends GenericManager<InventoryRecord,Long>{
    /**
     * 批量存
     * @param inventoryRecordList
     * @return
     */
    List<InventoryRecord> saveInventoryRecordList(List<InventoryRecord> inventoryRecordList);
}
