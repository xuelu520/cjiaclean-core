 ...
 * @since [产品/模块版本] （可选）
 */
@Repository("goodsMaterielDao")
public class GoodsMaterielDaoHibernate extends GenericDaoHibernate<GoodsMateriel,Long> implements GoodsMaterielDao {

    public GoodsMaterielDaoHibernate() {
        super(GoodsMateriel.class);
    }
}
