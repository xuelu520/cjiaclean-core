 ...
 * @since [产品/模块版本] （可选）
 */
@Repository("inventoryRecordDao")
public class InventoryRecordDaoHibernate extends GenericDaoHibernate<InventoryRecord,Long> implements InventoryRecordDao {

    public InventoryRecordDaoHibernate() {
