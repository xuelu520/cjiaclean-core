 ...
 */
public class HotelApplyDetalsVO implements Serializable {
    ...
    private String hotelUniqueNo;//唯一编码
    ...
    private String onlineRate; //门店线上毛利率
    private String storeRate; //门店线下利率
    private String channelOnlineRate; //建议线上毛利率
    private String channelStoreRate; //建议线下毛利率
    ...
    public String getChannelStoreRate() {
        return channelStoreRate;
    }

    public void setChannelStoreRate(String channelStoreRate) {
        this.channelStoreRate = channelStoreRate;
    }

    public String getChannelOnlineRate() {
        return channelOnlineRate;
    }

    public void setChannelOnlineRate(String channelOnlineRate) {
        this.channelOnlineRate = channelOnlineRate;
    }
}
