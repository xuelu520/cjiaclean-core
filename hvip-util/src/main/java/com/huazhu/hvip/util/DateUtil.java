...
//            defaultDatePattern = ResourceBundle.getBundle(Constants.BUNDLE_KEY, locale).getString("date.format");
    ...
    public static final int getDaysBetween(Date early, Date late) {
        ...
        // 得到两个日期相差的天数
        int days = (int) (((long) (caled.getTime().getTime() - calst.getTime().getTime())) / 1000 / 3600 / 24);
    ...
    // 相差时间毫秒
    public static final Long getDateBetween(Date early, Date late) {
        ...
        // System.out.println(getDateTime("yyyy-MM-dd",caled.getTime()));
        Long days =  (((caled.getTime().getTime() - calst.getTime().getTime())));
        return days;
    }
    ...
    public static Long getDateline(String date) {
        try {
            return (long) (convertStringToDate("yyyy-MM-dd", date).getTime() / 1000);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static Long getDateHaveHour(String date) {
        try {
            return (long) (convertStringToDate("yyyy-MM-dd HH", date).getTime() / 1000);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static Long getDateline(String date, String pattern) {
        try {
            return (long) (convertStringToDate(pattern, date).getTime() / 1000);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static void main(String[] args) {
        Date date = new Date();
        String aa = convertDateToString(date,"MM-dd");
