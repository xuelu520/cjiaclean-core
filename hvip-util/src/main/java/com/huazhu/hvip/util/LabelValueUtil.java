 ...
 */
public class LabelValueUtil implements Comparable, Serializable {

    private static final long serialVersionUID = 3689355407466181430L;

    /**
     * Comparator that can be used for a case insensitive sort of
     * <code>LabelValueUtil</code> objects.
     */
    public static final Comparator CASE_INSENSITIVE_ORDER = new Comparator() {
        public int compare(Object o1, Object o2) {
            String label1 = ((LabelValueUtil) o1).getLabel();
            String label2 = ((LabelValueUtil) o2).getLabel();
     ...
     */
    public LabelValueUtil(final String label, final String value) {
        this.label = label;
        this.value = value;
    }
     ...
     *
     * @see Comparable
     * @param o LabelValueUtil object to compare to
     * @return 0 if labels match for compared objects
     */
    public int compareTo(Object o) {
        // Implicitly tests for the correct type, throwing
        // ClassCastException as required by interface
        String otherLabel = ((LabelValueUtil) o).getLabel();
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("LabelValueUtil[");
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LabelValueUtil)) {
            return false;
        }

        LabelValueUtil bean = (LabelValueUtil) obj;
