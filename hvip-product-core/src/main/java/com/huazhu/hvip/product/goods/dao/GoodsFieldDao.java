...
/**
 * An interface that provides a data management interface to the GoodsField table.
 */
public interface GoodsFieldDao extends GenericDao<GoodsField, Long> {
